...
(0, _jquery2.default)('.sidebar-menu').on('click', function () {
  (0, _jquery2.default)(this).toggleClass("active");return false;
});
...
;(function ($, window, document, undefined) {
  ...
  var el = _foundationSites2.default.utils.S("ul[data-options*='block_width']");
  if (el.length) {
    var s = _foundationSites2.default.utils.data_options(el).block_width;
    if (s !== undefined) {
      var w = s.length === 0 ? 300 : parseInt(s);
      $(window).on('resize.block-grid', _foundationSites2.default.utils.debounce(function (e) {
...
(0, _jquery2.default)(function () {
  ...
  (0, _jquery2.default)(window).scroll(function (event) {
    ...
    var newScroll = (0, _jquery2.default)(this).scrollTop();
    //Determines up-or-down scrolling
    if (newScroll < lastScroll || window.pageYOffset < 129) {
      (0, _jquery2.default)('#XXX global-navigation').slideDown(200);
    } else {
      (0, _jquery2.default)('#XXX global-navigation').slideUp(200);
    }
...
(0, _jquery2.default)(document).ready(function () {
  (0, _jquery2.default)(".no-touch .scroll").click(function (event) {
    event.preventDefault();
    //calculate destination place
    var dest = 0;
    if ((0, _jquery2.default)(this.hash).offset().top > (0, _jquery2.default)(document).height() - (0, _jquery2.default)(window).height()) {
      dest = (0, _jquery2.default)(document).height() - (0, _jquery2.default)(window).height();
    } else {
      dest = (0, _jquery2.default)(this.hash).offset().top - 50;
    }
    //go to destination
    (0, _jquery2.default)('html,body').animate({ scrollTop: dest }, 1000, 'swing');
  });
});

// Show or hide the Back To Top button - Credit umhb.edu
(0, _jquery2.default)(window).scroll(function () {
  if ((0, _jquery2.default)(this).scrollTop() > 600) {
    (0, _jquery2.default)('.go-top').fadeIn(200);
  } else {
    (0, _jquery2.default)('.go-top').fadeOut(200);
  }
});
// Animate the scroll to top
(0, _jquery2.default)('.go-top').click(function (event) {
  event.preventDefault();
...
(0, _jquery2.default)(document).ready(function () {
  ...
  (0, _jquery2.default)("a.toggle-switch").html("+ Expand all");
  (0, _jquery2.default)(".toggle-content").click(function () {
    (0, _jquery2.default)(this).toggleClass("open").nextAll(".toggle-content").slideToggle("fast"); // Apply "open" class.
  });
  (0, _jquery2.default)(".toggle-content").hide();
  (0, _jquery2.default)(".toggle-trigger").click(function (e) {
    e.preventDefault();
    (0, _jquery2.default)(this).toggleClass("open").nextAll(".toggle-content").slideToggle("fast"); // Apply "open" class
  });
  // To expand and collapse all toggles simultaneously, just toggle-trigger the click event. The multiply sign is JS hex value \u00d7.
  (0, _jquery2.default)("a.toggle-switch").click(function () {
    var label = (0, _jquery2.default)(".toggle-switch").html();
    var other = '\xD7 Collapse all';
    if (label === '\xD7 Collapse all') {
      other = "+ Expand all";
    }
    (0, _jquery2.default)(".toggle-trigger").each(function () {
      (0, _jquery2.default)(this).toggleClass("open").nextAll(".toggle-content").slideToggle("fast");
    });
    (0, _jquery2.default)(".toggle-switch").html(other);
  });
});
...
!function (e) {
  ...
  function t(e, t, a) {
    var i;return function () {
      var n = this,
        ...
        i = null, a || e.apply(n, o);
          ...
          s = a && !i;clearTimeout(i), i = setTimeout(r, t), s && e.apply(n, o);
    };
  }function a(e) {
    var t = ++h;return String(null == e ? "rmjs-" : e) + t;
  }function i(e) {
    var t = e.clone().css({ height: "auto", width: e.width(), maxHeight: "none", overflow: "hidden" }).insertAfter(e),
        a = t.outerHeight(),
        i = parseInt(t.css({ maxHeight: "" }).css("max-height").replace(/[^-\d\.]/g, ""), 10),
        n = e.data("defaultHeight");t.remove();var o = i || e.data("collapsedHeight") || n;e.data({ expandedHeight: a, maxHeight: i, collapsedHeight: o }).css({ maxHeight: "none" });
  }function n(e) {
    if (!d[e.selector]) {
      var t = " ";e.embedCSS && "" !== e.blockCSS && (t += e.selector + " + [data-readmore-toggle], " + e.selector + "[data-readmore]{" + e.blockCSS + "}"), t += e.selector + "[data-readmore]{transition: height " + e.speed + "ms;overflow: hidden;}", function (e, t) {
        var a = e.createElement("style");a.type = "text/css", a.styleSheet ? a.styleSheet.cssText = t : a.appendChild(e.createTextNode(t)), e.getElementsByTagName("head")[0].appendChild(a);
      }(document, t), d[e.selector] = !0;
    }
  }function o(t, a) {
    this.element = t, this.options = e.extend({}, s, a), n(this.options), this._defaults = s, this._name = r, this.init(), window.addEventListener ? (window.addEventListener("load", l), window.addEventListener("resize", l)) : (window.attachEvent("load", l), window.attachEvent("resize", l));
  }var r = "readmore",
    ...
    e("[data-readmore]").each(function () {
      var t = e(this),
          a = "true" === t.attr("aria-expanded");i(t), t.css({ height: t.data(a ? "expandedHeight" : "collapsedHeight") });
    });
  }, 100);o.prototype = { init: function init() {
      var t = this,
          n = e(this.element);n.data({ defaultHeight: this.options.collapsedHeight, heightMargin: this.options.heightMargin }), i(n);var o = n.data("collapsedHeight"),
          r = n.data("heightMargin");if (n.outerHeight(!0) <= o + r) return !0;var s = n.attr("id") || a(),
          d = t.options.startOpen ? t.options.lessLink : t.options.moreLink;n.attr({ "data-readmore": "", "aria-expanded": !1, id: s }), n.after(e(d).on("click", function (e) {
        t.toggle(this, n[0], e);
      }).attr({ "data-readmore-toggle": "", "aria-controls": s })), t.options.startOpen || n.css({ height: o });
    }, toggle: function toggle(t, a, i) {
      i && i.preventDefault(), t || (t = e('[aria-controls="' + this.element.id + '"]')[0]), a || (a = this.element);var n = this,
          o = e(a),
          r = "",
          s = "",
          d = !1,
          h = o.data("collapsedHeight");o.height() <= h ? (r = o.data("expandedHeight") + "px", s = "lessLink", d = !0) : (r = h, s = "moreLink"), n.options.beforeToggle(t, a, !d), o.css({ height: r }), o.on("transitionend", function () {
      ...
      e(this.element).each(function () {
        var t = e(this);t.attr({ "data-readmore": null, "aria-expanded": null }).css({ maxHeight: "", height: "" }).next("[data-readmore-toggle]").remove(), t.removeData();
      });
    } }, e.fn.readmore = function (t) {
    var a = arguments,
        i = this.selector;return t = t || {}, "object" == (typeof t === 'undefined' ? 'undefined' : _typeof(t)) ? this.each(function () {
      if (e.data(this, "plugin_" + r)) {
        var a = e.data(this, "plugin_" + r);a.destroy.apply(a);
      }t.selector = i, e.data(this, "plugin_" + r, new o(this, t));
    }) : "string" == typeof t && "_" !== t[0] && "init" !== t ? this.each(function () {
      var i = e.data(this, "plugin_" + r);i instanceof o && "function" == typeof i[t] && i[t].apply(i, Array.prototype.slice.call(a, 1));
    }) : void 0;
  };
}(jQuery);
(0, _jquery2.default)('.showmore').readmore({
  speed: 500,
  collapsedHeight: 180,
  ...
  afterToggle: function afterToggle(trigger, element, expanded) {
    ...
    if (!expanded) {
      ...
      (0, _jquery2.default)('html, body').animate({ scrollTop: (0, _jquery2.default)(element).offset().top - 145 }, { duration: 400 });
    }
  }
